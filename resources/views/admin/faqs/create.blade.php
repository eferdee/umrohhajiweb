        ...
        <form method="POST" action="{{ route('admin.faqs.store') }}" class="space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="category" value="{{ old('category') }}" placeholder="General"
            ...
            <div>
                ...
                <textarea name="answer" rows="5"
                          class="w-full border border-[var(--color-line)] rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]/30 @error('answer') border-[var(--color-danger)] @enderror">{{ old('answer') }}</textarea>
